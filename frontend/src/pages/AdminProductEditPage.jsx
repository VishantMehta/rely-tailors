        ...
        <div className="bg-[#f2f2f2] min-h-screen">
            <div className="container mx-auto p-4 sm:p-6 lg:p-8">
                <Link
                    ...
                    className="text-sm font-bold text-slate-600 hover:text-slate-900 mb-4 inline-block"
                >
                    &larr; Go Back
                </Link>
                    ...
                    {loading ? (
                        ...
                        <form onSubmit={submitHandler}>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <input
                                        ...
                                        className="mt-2 w-full text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-slate-100 file:text-slate-700 hover:file:bg-slate-200"
                                    />
                                    {uploading && (
                            ...
                            <div className="mt-8 border-t pt-6">
                                <h2 className="font-marcellus text-2xl text-slate-900 mb-4">
                                    Customizations
                                </h2>
                                    ...
                                    >
                                        <div className="flex justify-between items-center mb-4">
                                            <input
                                                ...
                                                value={cust.name}
                                                onChange={(e) =>
                                                    handleCustomizationNameChange(custIndex, e.target.value)
                                                }
                                        ...
                                        {cust.options.map((opt, optIndex) => (
                                            ...
                                            >
                                                <input
                                                    ...
                                                    className="w-1/2 p-2 border border-slate-200 rounded-md text-sm"
                                                />
                                                <input
                                                    type="number"
                                                    ...
                                                    className="w-1/3 p-2 border border-slate-200 rounded-md text-sm"
                                                />
                                                <button
                                                    type="button"
                                ...
                                <button
                                    ...
                                    className="w-full p-2 border-2 border-dashed rounded-md hover:bg-slate-100 transition-colors"
                                >
                            ...
                            <button
                                type="submit"
                                className="mt-8 w-full bg-slate-900 text-white font-bold py-3 px-8 rounded-md hover:bg-slate-800 transition-colors disabled:opacity-50"
