...
      {/* --- Hero Section --- */}
      <div className="relative bg-gradient-to-r from-slate-900 to-slate-800 py-20 sm:py-24 md:py-32 overflow-hidden">
        <BackgroundCubes />
...
      {/* --- Come & Say Hi Section --- */}
      <div className="bg-[#f2f2f2] py-16 sm:py-20 md:py-24 relative overflow-hidden">
        <BackgroundCubes />
