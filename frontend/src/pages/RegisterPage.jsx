...
// These components can be moved to a separate file to be reused
const FacebookIcon = () => (
        ...
        <div className="container mx-auto p-4">
          <div className="flex flex-col md:flex-row w-full max-w-5xl mx-auto overflow-hidden rounded-lg">
            ...
            <div className="w-full md:w-1/2 flex flex-col justify-center p-8 md:p-12 text-white">
              <h1 className="text-5xl md:text-6xl font-extrabold mb-4 leading-tight">Join Us Today</h1>
              <p className="text-gray-300 mb-8">
                Create an account to begin your journey into bespoke tailoring. Save your measurements and track your orders with ease.
              </p>
            ...
            <div className="w-full md:w-1/2 flex flex-col justify-center p-8 md:p-12 bg-white bg-opacity-5 backdrop-blur-md">
              <form>
                ...
                <div className="mb-5">
                  ...
                  <input type="text" id="name" className="input-glow bg-gray-700 bg-opacity-50 border border-gray-600 text-white text-sm rounded-lg focus:ring-amber-500 focus:border-amber-500 block w-full p-3 transition duration-300" placeholder="John Doe" required />
                </div>
