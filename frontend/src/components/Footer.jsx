...
const Footer = () => {
  ...
  <input 
    ...
    className="bg-slate-700 text-white px-4 py-1rounded-sm-md focus:outline-none w-80 text-sm" 
  />
  <button 
    type="submit" 
    className="bg-amber-500 text-slate-900 px-6 py-1 rounded-r-sm font-bold hover:bg-amber-600 transition-colors text-sm"
  >
    Sign Up
  </button>
</form>
        ...
        <div className="mt-16 border-t border-slate-700 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-slate-500">
